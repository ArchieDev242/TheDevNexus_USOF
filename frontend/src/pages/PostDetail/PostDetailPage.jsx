                ...
                <div className="post-detail-container">
                    ...
                    <div className="post-detail-card">
                        ...
                        <div className="post-actions">
                            ...
                            >
                                <FiBookmark /> {save_status ? <span>Збережено</span> : ''}
                            </button>
                        </div>
                    </div>
                ...
                {show_reply_form && is_authenticated && (
                    <form className="inline-reply-form" onSubmit={handle_submit_reply}>
                        <div className="reply-form-header">
                            <div class="reply-form-header__info">
                                <span class="reply-form-header__title">Відповідь для:</span>
                                <strong>@unity_master</strong>
                            </div>
                            <button
                                type="button"
